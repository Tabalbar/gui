...
public class Eevee extends Pokemon implements NormalType {
   ...
   */
   public Eevee() {
      super("Eevee", "Eevee", 7, NORMAL_COLOR, 0.3, 6.5, 
   ...
   */
   public Eevee(String name) {
      super("Eevee", name, 7, NORMAL_COLOR, 0.3, 6.5, 
         NORMAL_TYPE, "", BASE_ATTACK_POWER, 
         BASE_DEFENSE_POWER, BASE_STAMINA_POWER);
      //pick Attacks
      chooseFastAttack();
   ...
   */
   protected Eevee(String species, String name, int num, String color,
       double ht, double wt, String type1,
       int baseAttackPwr, int baseDefensePwr, int baseStaminaPwr) {
       
      super(species, name, num, color, ht, wt, type1, "",
            baseAttackPwr, baseDefensePwr, baseStaminaPwr);
      //pick Attacks
      //can happen here because all subclasses are same types as Eevee
      chooseFastAttack();
      chooseSpecialAttack();
   }
   ...
   */
   protected void chooseFastAttack() {
      //Generate Random WaterFastAttack[]
   ...
   */
   protected void chooseSpecialAttack() {
      //Generate random WaterSpecialAttack[]
      Random randGen = new Random();
      int index;
   ...
   */
   public String performFastAttack(Pokemon victim) {
      ...
      if (fastIsNormal) { //if attack is Normal
         if (vType.equals("Ghost")) {
            
            s = s + "\n It was super effective!";
            modifier = modifier * 2.0;          
         } else if (vType.equals("Fighting")) { 
