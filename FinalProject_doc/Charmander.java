...
public class Charmander extends Pokemon implements FireType {
   ...
   */
   protected Charmander(String species, String name, int num, String color, 
   ...
   /**
   * Water specific fast attack chooser.
   ...
   */
   public String performFastAttack(Pokemon victim) {
      ...
      if (fastIsFire) { //if attack is Fire
         ...
         } else if (vType.equals("Ground") || vType.equals("Rock")
            || vType.equals("Water") || vType.equals("Fire")) { 
