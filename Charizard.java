...
public class Charizard extends Charmeleon implements FlyingType {
   ...
   public Charizard() {
      super("Charizard", "Charizard", 6, FIRE_COLOR, 1.7, 90.5, FIRE_TYPE,
   ...
   */
   public Charizard(String name) {
      super("Charizard", name, 6, FIRE_COLOR, 1.7, 90.5, FIRE_TYPE,
            FLYING_TYPE, BASE_ATTACK_POWER, 
            BASE_DEFENSE_POWER, BASE_STAMINA_POWER);
      chooseFastAttack();
      chooseSpecialAttack();
     ...
     /**
   * fire|flying specific special attack chooser.
   ...
   */
   public String performFastAttack(Pokemon victim) {
      ...
      if (fastIsFire) { //if attack is Fire-type
         ...
         if (vType.equals("Fighting") || vType.equals("Bug")
            || vType.equals("Grass")) {
            s = s + "\n It was super effective!";
            modifier = modifier * 2.0;
